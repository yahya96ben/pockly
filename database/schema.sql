...
-- ─────────────────────────────────────────────────────────────────────────────
-- SEED DATA (4 demo restaurants, including Soleil Bakkery)
-- ─────────────────────────────────────────────────────────────────────────────
...
VALUES
  ...
  ('44444444-4444-4444-4444-444444444444', 'Soleil Bakkery',   'Place Colignon 32, 1030 Schaerbeek',      '+32470444444', 'Boulangerie',  '🥐', 10, TRUE, 8, '1 viennoiserie offerte')
...
VALUES
  ...
  -- Soleil Bakkery — boulangerie artisanale, locale, chaleureuse (Schaerbeek)
  ('44444444-4444-4444-4444-444444444444', 'unit', 'Croissant',          'Croissant pur beurre, feuilletage maison.',           '🥐', 'Viennoiserie', 2.00, 24),
  ('44444444-4444-4444-4444-444444444444', 'unit', 'Pain au chocolat',   'Pâte feuilletée et chocolat noir équitable.',         '🍫', 'Viennoiserie', 2.00, 24),
  ('44444444-4444-4444-4444-444444444444', 'unit', 'Cinnamon roll',      'Brioche roulée à la cannelle, glaçage léger.',        '🌀', 'Viennoiserie', 2.30, 18),
  ('44444444-4444-4444-4444-444444444444', 'unit', 'Cardamom bun',       'Brioche scandinave parfumée à la cardamome.',         '🌀', 'Viennoiserie', 2.30, 18),
  ('44444444-4444-4444-4444-444444444444', 'unit', 'Country white',      'Pain de campagne au levain, croûte épaisse.',         '🍞', 'Pains',        5.30, 10),
  ('44444444-4444-4444-4444-444444444444', 'unit', 'Pain complet',       'Pain complet au levain, farine bio locale.',          '🌾', 'Pains',        5.50, 10),
  ('44444444-4444-4444-4444-444444444444', 'unit', 'Bouteille de kéfir', 'Kéfir de fruits artisanal, fermenté maison.',         '🥛', 'Boissons',     8.00, 12)
...
-- ============================================================================
-- DONE. You should now have 4 tables, 4 demo restaurants, 10 sample products.
